...
- Read `@_build_plan/milestones/1-end-to-end-scraper/milestone-log.md` to understand what was built in milestone 1.
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/milestones/2-concurrent-fetching/milestone-log.md`). Structure it as follows:
